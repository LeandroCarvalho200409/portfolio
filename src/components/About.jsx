...
export function About() {
  ...
  const textPT = (
    <>
      ...
      <p className="text-center text-[14pt]">
        Embora não tenha muita experiência nessas áreas, interesso-me imenso por Machine Learning, cibersegurança, assim como eletrónica e sistemas embebidos (Embedded Systems).
      </p>
  ...
  return (
    <section id="about" className="about-section flex flex-col items-center max-w-[100%] mx-auto pt-[200px] pb-[50px] bg-primary px-[5rem]" style={{ minHeight: "100vh" }}>
